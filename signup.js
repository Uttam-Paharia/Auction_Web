...
window.addEventListener('DOMContentLoaded', () => {
    ...
    form1.addEventListener('submit', (event) => {
        ...
        //     if (document.getElementById('phone_error').innerHTML=="Please enter a valid phone number") {
...
()=> {
    ...
    {
        document.querySelector('#confirm_password_error').innerHTML = "Enter the password again";
        document.querySelector('#confirm_password_tick').innerHTML = "";
    }
    else{
        document.querySelector('#confirm_password_error').innerHTML = "";
        document.querySelector('#confirm_password_tick').innerHTML = "<i class='fa-solid fa-square-check' style='color: #22aa32;'></i>";
    }
    });
}
{
...
()=> {
    ...
    if(! pattern.test(val))
    {
        document.querySelector('#email_error').innerHTML = "Enter a valid email";
    }
    else{
...
countElement.textContent = characterCount + '/255';
...
function countCharacters_password(){
const inputElement = document.getElementById('password');
const countElement =document.getElementById('characterCount_password');
const characterCount_password=inputElement.value.length;
countElement.textContent =characterCount_password;
}